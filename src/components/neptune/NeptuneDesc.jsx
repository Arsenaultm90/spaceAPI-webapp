	...
	return (
		<div className='desc'>
			<p className='desc-content'>
				...
				atmosphere. It is referred to as one of the solar system's two ice giant
				planets (the other one being Uranus).
				<br></br>
				<br></br>
				Being composed primarily of gases and liquids, it has no well-defined
				"solid surface". The planet orbits the Sun once every 164.8 years at an
				average distance of 30.1 AU (4.5 billion km; 2.8 billion mi). It is
				...
				Solar System found by mathematical prediction rather than by empirical
				observation. Unexpected changes in the orbit of Uranus led Alexis
				Bouvard to hypothesise that its orbit was subject to gravitational
				...
				remains the only spacecraft to have visited Neptune. The advent of the
				Hubble Space Telescope and large ground-based telescopes with adaptive
				optics has recently allowed for additional detailed observations from
				afar.
				<br></br>
				<br></br>
				...
				nitrogen, though it contains a higher proportion of ices such as water,
				...
				considered "ice giants" to emphasise this distinction. Along with
				Rayleigh scattering, traces of methane in the outermost regions in part
				account for the planet's blue appearance. Newest data from the Gemini
				observatory shows the blue color is more saturated than the one present
				on Uranus due to thinner haze of Neptune's more active atmosphere.
				<br></br>
				<br></br>
				...
				System, with temperatures at its cloud tops approaching 55 K (−218C;
				−361F). Temperatures at the planet's centre are approximately 5,400 K
				(5,100C; 9,300F). Neptune has a faint and fragmented ring system
				(labelled "arcs"), which was discovered in 1984, then later confirmed by
				Voyager 2.
			</p>
		</div>
	);
